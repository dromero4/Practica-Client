...
import { guardar, restaurar, leerImagenBase64, listarArchivos } from './dibujar.js';
import fs from 'fs';
...
// // Ruta que rep dades en la URL (http://localhost:3000/hola2/?nom=peter)
// app.get('/hola2', (req, res) => {
//     res.send(`¡Hola, ${req.query.nom}!`);
// });

// // Ruta que genera una pàgina web a partir d'una plantilla (http://localhost:3000/hola3/?nom=Peter)
// app.get('/hola3', (req, res) => {
//     res.render("missatge", { nom: req.query.nom });
// });

// Ruta que rep dades en el cos de la petició (format JSON)
